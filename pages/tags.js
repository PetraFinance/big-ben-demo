...
// A single calendar item in the side panel
      ...
      <div className="calendar-list">
        <div className="calendar-list-header">
          ...
          <div className="arrow-img">
            <img src={prefixLink("./assets/grey-down-arrow.png")} />
          </div>
        </div>
...
export default class AllCalendarsList extends React.Component {
  ...
  render () {
    ...
    return (
      <div className="all-calendar-list-container">
        {allCalendarsList}
      </div>
    )
  }
